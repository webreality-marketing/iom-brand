...
(lib.mc_level1_336 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// s
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#EC0000").s().p("AgrA7QAAgKACgJQARAJATAAQAaAAAAgRQABgIgGgFQgEgEgLgEIgKgEQgQgHgIgGQgJgKAAgPQgBgRAMgJQANgKAVAAQAVAAAQAGQgBALgCAHQgRgFgQAAQgZAAAAAQQAAANAWAJIAKAEQASAGAHAHQAJAJAAAOQAAARgNAKQgOALgWAAQgXAAgQgJg");
	this.shape.setTransform(254.8,53.475);
	this.shape._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(42).to({_off:false},0).wait(258));

	// e
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#EC0000").s().p("AgmAyQgQgSAAggQAAgeAOgRQAPgUAbAAQAaAAAOAQQANAPAAAbIgCAQIhTAAQADAqAmAAQAVAAASgKIgDAUQgPAJgXAAQgfAAgQgSgAAggKQgBgmgeAAQgcAAgDAmIA+AAIAAAAg");
	this.shape_1.setTransform(242.925,53.475);
	this.shape_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(41).to({_off:false},0).wait(259));

	// g
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#EC0000").s().p("AgqBXIABgTQASAIARAAQAmAAAAgmIAAgRQgLATgWAAQgYAAgOgRQgOgRAAggQAAhEA+AAQAZgBAUAIIAAB6QAAA8g7AAQgVABgQgJgAgegbQAAAxAiAAQAQAAAMgNIAAhSQgLgDgMAAQgnAAAAAxg");
	this.shape_2.setTransform(229.575,56.25);
	this.shape_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_2).wait(40).to({_off:false},0).wait(260));

	// a
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#EC0000").s().p("AgmA0QgOgSAAgiQAAhDA9AAQAYAAAUAHIAAB9IgUAAIgCgRQgLAUgWAAQgXAAgNgQgAgdAAQAAAxAgAAQAQAAAMgMIAAhTQgLgCgLAAQgmAAAAAwg");
	this.shape_3.setTransform(216.275,53.475);
	this.shape_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_3).wait(39).to({_off:false},0).wait(261));

	// g
	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#EC0000").s().p("AgqBXIABgTQASAIARAAQAmAAAAgmIAAgRQgLATgWAAQgYAAgOgRQgOgRAAggQAAhEA+AAQAZgBAUAIIAAB6QAAA8g7AAQgVABgQgJgAgegbQAAAxAiAAQAQAAAMgNIAAhSQgLgDgMAAQgnAAAAAxg");
	this.shape_4.setTransform(202.975,56.25);
	this.shape_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_4).wait(38).to({_off:false},0).wait(262));

	// t
	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#EC0000").s().p("AgeAuIAAh/QAJgEAOAAIAAAnIAmAAIgCATIgkAAIAABHQAAAXASAAQAKAAAJgFIgCATQgJAFgNAAQgkAAAAgog");
	this.shape_5.setTransform(192.8,51.675);
	this.shape_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_5).wait(37).to({_off:false},0).wait(263));

	// r
	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#EC0000").s().p("AgiBCIAAh8QAVgHAVAAQAPAAALACQAAANgBAGQgKgCgPAAQgIAAgLACIAABug");
	this.shape_6.setTransform(184.3,53.35);
	this.shape_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_6).wait(36).to({_off:false},0).wait(264));

	// o
	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#EC0000").s().p("AgqAyQgPgSgBggQABgfAPgSQAPgSAbAAQAcAAAQASQAPASgBAfQAAAggPASQgPASgcAAQgbAAgPgSgAgiAAQAAAxAiAAQAkAAAAgxQAAgwgkAAQgiAAAAAwg");
	this.shape_7.setTransform(172.55,53.475);
	this.shape_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_7).wait(35).to({_off:false},0).wait(265));

	// m
	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#EC0000").s().p("ABEBCIAAhTQAAgPgHgIQgHgHgQAAQgQAAgOAIQADAIAAAMIAABVIgVAAIAAhTQAAgQgHgHQgHgHgRAAQgMAAgOADIAABuIgXAAIAAh8QAbgHAWAAQAdAAAMAMQARgMAaAAQAwAAAAAtIAABWg");
	this.shape_8.setTransform(155.325,53.325);
	this.shape_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_8).wait(34).to({_off:false},0).wait(266));

	// d
	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#EC0000").s().p("AgnBNQgOgSAAghQAAhDA+AAQAMAAALACIAAgyQAJgEANABIAAC2IgVAAIgBgRQgLAUgWAAQgYAAgOgQgAgeAaQAAAxAiAAQAQAAAMgNIAAhRQgLgDgMgBQgnABAAAwg");
	this.shape_9.setTransform(132.375,50.9);
	this.shape_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_9).wait(33).to({_off:false},0).wait(267));

	// n
	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#EC0000").s().p("AAcBCIAAhTQAAgQgGgHQgIgHgQAAQgMAAgOADIAABuIgWAAIAAh8QAagHAXAAQA0AAAAAuIAABVg");
	this.shape_10.setTransform(119.5,53.325);
	this.shape_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_10).wait(32).to({_off:false},0).wait(268));

	// a
	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#EC0000").s().p("AgmA0QgOgSAAgiQAAhDA9AAQAYAAAUAHIAAB9IgUAAIgCgRQgLAUgWAAQgXAAgNgQgAgdAAQAAAxAgAAQAQAAAMgMIAAhTQgLgCgLAAQgmAAAAAwg");
	this.shape_11.setTransform(105.725,53.475);
	this.shape_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_11).wait(31).to({_off:false},0).wait(269));

	// s
	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#EC0000").s().p("AgrA7QAAgKADgJQAQAJATAAQAaAAABgRQAAgIgGgFQgEgEgLgEIgKgEQgQgHgIgGQgJgKAAgPQAAgRALgJQANgKAVAAQAVAAAQAGQgBALgCAHQgRgFgQAAQgZAAAAAQQAAANAWAJIAKAEQASAGAHAHQAJAJgBAOQAAARgMAKQgNALgXAAQgXAAgQgJg");
	this.shape_12.setTransform(89.1,53.475);
	this.shape_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_12).wait(30).to({_off:false},0).wait(270));

	// t
	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#EC0000").s().p("AgeAuIAAh/QAJgEAOAAIAAAnIAmAAIgCATIgkAAIAABHQAAAXATAAQAJAAAJgFIgCATQgJAFgNAAQgkAAAAgog");
	this.shape_13.setTransform(79.85,51.675);
	this.shape_13._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_13).wait(29).to({_off:false},0).wait(271));

	// n
	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#EC0000").s().p("AAdBCIAAhTQAAgQgIgHQgGgHgRAAQgLAAgOADIAABuIgXAAIAAh8QAagHAXAAQA0AAAAAuIAABVg");
	this.shape_14.setTransform(68.6,53.325);
	this.shape_14._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_14).wait(28).to({_off:false},0).wait(272));

	// u
	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#EC0000").s().p("AgyAUIAAhVIAXAAIAABTQAAAQAGAHQAHAHARAAQALAAAPgDIAAhuIAWAAIAAB8QgaAHgXAAQg0AAAAgug");
	this.shape_15.setTransform(55.1,53.625);
	this.shape_15._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_15).wait(27).to({_off:false},0).wait(273));

	// o
	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#EC0000").s().p("AgrAyQgPgSAAggQAAgfAPgSQAQgSAbAAQAcAAAQASQAOASAAAfQAAAggPASQgPASgcAAQgbAAgQgSgAgiAAQAAAxAiAAQAkAAAAgxQAAgwgkAAQgiAAAAAwg");
	this.shape_16.setTransform(41.8,53.475);
	this.shape_16._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_16).wait(26).to({_off:false},0).wait(274));

	// c
	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#EC0000").s().p("AgbAzQgRgSAAghQAAgfAPgSQAQgSAeAAQARAAALAFQAAAJgCAKQgLgFgOAAQgnAAAAAwQAAAXAKANQALANASAAQAPAAAMgGQgBAKgCAJQgKAGgRAAQgbAAgPgRg");
	this.shape_17.setTransform(29.9,53.475);
	this.shape_17._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_17).wait(25).to({_off:false},0).wait(275));

	// c
	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#EC0000").s().p("AgbAzQgRgSAAghQAAgfAPgSQAQgSAeAAQARAAALAFQAAAJgCAKQgMgFgNAAQgnAAAAAwQAAAXALANQAKANASAAQAPAAAMgGQgBAKgCAJQgKAGgQAAQgbAAgQgRg");
	this.shape_18.setTransform(19.3,53.475);
	this.shape_18._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_18).wait(24).to({_off:false},0).wait(276));

	// a
	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#EC0000").s().p("AgmA0QgOgSAAgiQAAhDA9AAQAYAAAUAHIAAB9IgUAAIgCgRQgLAUgWAAQgXAAgNgQgAgdAAQAAAxAgAAQAQAAAMgMIAAhTQgLgCgLAAQgmAAAAAwg");
	this.shape_19.setTransform(7.025,53.475);
	this.shape_19._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_19).wait(23).to({_off:false},0).wait(277));

	// s
	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#EC0000").s().p("AgsA7QABgKADgJQAQAJATAAQAbAAAAgRQgBgIgFgFQgEgEgLgEIgKgEQgRgHgHgGQgKgKAAgPQAAgRANgJQALgKAWAAQAVAAAQAGQgBALgCAHQgQgFgQAAQgZAAAAAQQAAANAUAJIALAEQARAGAIAHQAIAJAAAOQAAARgMAKQgOALgWAAQgXAAgRgJg");
	this.shape_20.setTransform(269.8,23.925);
	this.shape_20._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_20).wait(22).to({_off:false},0).wait(278));

	// g
	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#EC0000").s().p("AgqBYIABgUQASAIARAAQAmAAAAgnIAAgRQgLAUgWAAQgYAAgOgQQgOgSAAggQAAhEA+AAQAZAAAUAGIAAB7QAAA8g7ABQgVgBgQgHgAgegbQAAAxAiAAQAQAAAMgNIAAhSQgLgDgMAAQgnAAAAAxg");
	this.shape_21.setTransform(257.325,26.7);
	this.shape_21._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_21).wait(21).to({_off:false},0).wait(279));

	// n
	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#EC0000").s().p("AAdBCIAAhTQAAgQgIgHQgGgHgRAAQgMAAgOADIAABuIgWAAIAAh8QAagHAXAAQA0AAAAAuIAABVg");
	this.shape_22.setTransform(244.45,23.775);
	this.shape_22._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_22).wait(20).to({_off:false},0).wait(280));

	// i
	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f("#EC0000").s().p("AgKBdIAAiAIAVAAIAACAgAgJhDQgFgEAAgHQAAgGAFgEQAEgEAFAAQAGAAAEAEQAFAEAAAGQAAAHgFAEQgEAEgGABQgFAAgEgFg");
	this.shape_23.setTransform(234.85,21.1);
	this.shape_23._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_23).wait(19).to({_off:false},0).wait(281));

	// v
	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f("#EC0000").s().p("AgKBBIgviBIAYAAIAiBoIAihoIAXAAIgvCBg");
	this.shape_24.setTransform(226.325,23.925);
	this.shape_24._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_24).wait(18).to({_off:false},0).wait(282));

	// a
	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f("#EC0000").s().p("AgmA0QgOgSAAgiQAAhDA9AAQAYAAAUAHIAAB9IgUAAIgCgRQgLAUgWAAQgXAAgNgQgAgdAAQAAAxAgAAQAQAAAMgMIAAhTQgLgCgLAAQgmAAAAAwg");
	this.shape_25.setTransform(213.625,23.925);
	this.shape_25._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_25).wait(17).to({_off:false},0).wait(283));

	// s
	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f("#EC0000").s().p("AgsA7QABgKACgJQARAJATAAQAaAAAAgRQAAgIgEgFQgFgEgLgEIgKgEQgRgHgHgGQgKgKAAgPQABgRAMgJQALgKAWAAQAVAAAQAGQgBALgCAHQgRgFgPAAQgZAAAAAQQgBANAVAJIALAEQARAGAIAHQAIAJABAOQAAARgNAKQgNALgXAAQgXAAgRgJg");
	this.shape_26.setTransform(202.1,23.925);
	this.shape_26._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_26).wait(16).to({_off:false},0).wait(284));

	// _
	this.shape_27 = new cjs.Shape();
	this.shape_27.graphics.f("#EC0000").s().p("AgOAhQAFgdABggQAKgEANAAQgEArgLAWg");
	this.shape_27.setTransform(188.175,31);
	this.shape_27._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_27).wait(15).to({_off:false},0).wait(285));

	// s
	this.shape_28 = new cjs.Shape();
	this.shape_28.graphics.f("#EC0000").s().p("AgrA7QAAgKACgJQARAJATAAQAbAAgBgRQAAgIgEgFQgFgEgLgEIgKgEQgRgHgHgGQgJgKgBgPQAAgRAMgJQAMgKAWAAQAVAAAQAGQgBALgCAHQgQgFgRAAQgZAAAAAQQAAANAWAJIAKAEQASAGAHAHQAJAJAAAOQAAARgNAKQgNALgXAAQgXAAgQgJg");
	this.shape_28.setTransform(179.85,23.925);
	this.shape_28._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_28).wait(14).to({_off:false},0).wait(286));

	// t
	this.shape_29 = new cjs.Shape();
	this.shape_29.graphics.f("#EC0000").s().p("AgeAuIAAh/QAKgEAMAAIAAAnIAnAAIgCATIglAAIAABHQABAXASAAQALAAAIgFIgCATQgJAFgMAAQglAAAAgog");
	this.shape_29.setTransform(170.6,22.125);
	this.shape_29._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_29).wait(13).to({_off:false},0).wait(287));

	// n
	this.shape_30 = new cjs.Shape();
	this.shape_30.graphics.f("#EC0000").s().p("AAcBCIAAhTQABgQgIgHQgGgHgQAAQgMAAgOADIAABuIgXAAIAAh8QAbgHAWAAQA0AAAAAuIAABVg");
	this.shape_30.setTransform(159.35,23.775);
	this.shape_30._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_30).wait(12).to({_off:false},0).wait(288));

	// u
	this.shape_31 = new cjs.Shape();
	this.shape_31.graphics.f("#EC0000").s().p("AgyAUIAAhVIAXAAIAABTQgBAQAIAHQAHAHAQAAQAMAAANgDIAAhuIAXAAIAAB8QgbAHgWAAQg0AAAAgug");
	this.shape_31.setTransform(145.85,24.075);
	this.shape_31._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_31).wait(11).to({_off:false},0).wait(289));

	// o
	this.shape_32 = new cjs.Shape();
	this.shape_32.graphics.f("#EC0000").s().p("AgrAyQgPgSABggQgBgfAPgSQAQgSAbAAQAcAAAPASQAPASABAfQAAAggQASQgPASgcAAQgbAAgQgSgAgjAAQAAAxAjAAQAjAAAAgxQAAgwgjAAQgjAAAAAwg");
	this.shape_32.setTransform(132.55,23.925);
	this.shape_32._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_32).wait(10).to({_off:false},0).wait(290));

	// c
	this.shape_33 = new cjs.Shape();
	this.shape_33.graphics.f("#EC0000").s().p("AgbAzQgRgSAAghQAAgfAPgSQAQgSAeAAQARAAALAFQAAAJgCAKQgMgFgNAAQgnAAAAAwQAAAXALANQAKANASAAQAPAAAMgGQgBAKgCAJQgKAGgQAAQgbAAgQgRg");
	this.shape_33.setTransform(120.65,23.925);
	this.shape_33._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_33).wait(9).to({_off:false},0).wait(291));

	// c
	this.shape_34 = new cjs.Shape();
	this.shape_34.graphics.f("#EC0000").s().p("AgcAzQgQgSAAghQAAgfAPgSQAQgSAdAAQASAAALAFQAAAJgCAKQgMgFgOAAQgmAAAAAwQAAAXALANQAKANASAAQAPAAAMgGQAAAKgDAJQgKAGgRAAQgbAAgQgRg");
	this.shape_34.setTransform(110.05,23.925);
	this.shape_34._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_34).wait(8).to({_off:false},0).wait(292));

	// a
	this.shape_35 = new cjs.Shape();
	this.shape_35.graphics.f("#EC0000").s().p("AgmA0QgOgSAAgiQAAhDA9AAQAYAAAUAHIAAB9IgUAAIgCgRQgLAUgWAAQgXAAgNgQgAgdAAQAAAxAgAAQAQAAAMgMIAAhTQgLgCgLAAQgmAAAAAwg");
	this.shape_35.setTransform(97.775,23.925);
	this.shape_35._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_35).wait(7).to({_off:false},0).wait(293));

	// g
	this.shape_36 = new cjs.Shape();
	this.shape_36.graphics.f("#EC0000").s().p("AgqBYIABgUQASAIARAAQAmAAAAgnIAAgRQgLAUgWAAQgYAAgOgQQgOgSAAggQAAhEA+AAQAZAAAUAGIAAB7QAAA8g7ABQgVgBgQgHgAgegbQAAAxAiAAQAQAAAMgNIAAhSQgLgDgMAAQgnAAAAAxg");
	this.shape_36.setTransform(79.375,26.7);
	this.shape_36._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_36).wait(6).to({_off:false},0).wait(294));

	// n
	this.shape_37 = new cjs.Shape();
	this.shape_37.graphics.f("#EC0000").s().p("AAcBCIAAhTQABgQgIgHQgGgHgQAAQgMAAgOADIAABuIgXAAIAAh8QAagHAXAAQA0AAAAAuIAABVg");
	this.shape_37.setTransform(66.45,23.775);
	this.shape_37._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_37).wait(5).to({_off:false},0).wait(295));

	// i
	this.shape_38 = new cjs.Shape();
	this.shape_38.graphics.f("#EC0000").s().p("AgLBdIAAiAIAWAAIAACAgAgJhDQgFgEAAgHQAAgGAFgEQAEgEAFAAQAGAAAEAEQAFAEgBAGQABAHgFAEQgEAEgGABQgFAAgEgFg");
	this.shape_38.setTransform(56.9,21.1);
	this.shape_38._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_38).wait(4).to({_off:false},0).wait(296));

	// k
	this.shape_39 = new cjs.Shape();
	this.shape_39.graphics.f("#EC0000").s().p("AAZBcIg0hEIAAgCIAxg6IAaAAIgyA7IA2BFgAg0BcIAAi0QALgDAMAAIAAC3g");
	this.shape_39.setTransform(48.85,21.2);
	this.shape_39._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_39).wait(3).to({_off:false},0).wait(297));

	// n
	this.shape_40 = new cjs.Shape();
	this.shape_40.graphics.f("#EC0000").s().p("AAcBCIAAhTQAAgQgGgHQgIgHgQAAQgMAAgOADIAABuIgWAAIAAh8QAagHAXAAQA0AAAAAuIAABVg");
	this.shape_40.setTransform(35.35,23.775);
	this.shape_40._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_40).wait(2).to({_off:false},0).wait(298));

	// a
	this.shape_41 = new cjs.Shape();
	this.shape_41.graphics.f("#EC0000").s().p("AgmA0QgOgSAAgiQAAhDA9AAQAYAAAUAHIAAB9IgUAAIgCgRQgLAUgWAAQgXAAgNgQgAgdAAQAAAxAgAAQAQAAAMgMIAAhTQgLgCgLAAQgmAAAAAwg");
	this.shape_41.setTransform(21.575,23.925);
	this.shape_41._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_41).wait(1).to({_off:false},0).wait(299));

	// B
	this.shape_42 = new cjs.Shape();
	this.shape_42.graphics.f("#EC0000").s().p("Ag6BcIAAizQAVgEAYAAQAgAAARANQAQAMAAAXQAAAdgaAMQAgAKAAAiQAAAYgPANQgQANgdAAgAgiBIIAeAAQAoAAAAgfQAAgggpAAIgdAAgAgihGIAAA8IAcAAQAjAAAAgfQAAgfgpAAg");
	this.shape_42.setTransform(8.65,21.175);

	this.timeline.addTween(cjs.Tween.get(this.shape_42).wait(300));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,275.9,68.9);
...
(lib._300x250 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(277.9,78.75,0.4946,0.4945,0,0,0,408.6,123.2);
	...
	this.instance_1.setTransform(150.05,209.85,0.7873,0.7874,0,0,0,72.1,17.1);
	this.instance_1.alpha = 0;
	new cjs.ButtonHelper(this.instance_1, 0, 1, 2, false, new lib.primary_cta(), 3);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({alpha:1},30).wait(270));

	// header
	this.instance_2 = new lib.mc_level1_336();
	this.instance_2.parent = this;
	this.instance_2.setTransform(103.8,150.45,0.8929,0.8929,0,0,0,86.3,77);
	...
	this.instance_3.setTransform(66,167.45,0.5756,0.5757,0,0,0,68.2,42.8);
	...
	this.instance_4.setTransform(150,125,1,0.4167,0,0,0,150,300);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({regY:299.9,y:-125.85},29,cjs.Ease.quartInOut).wait(271));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(149,-125.8,152,376.8);
// library properties:
lib.properties = {
